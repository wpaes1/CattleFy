 ...
 * @publicApi
 */
import { ModelElement, type Marker, type Model, type ModelRange, type ModelItem } from 'ckeditor5/src/engine.js';
 ...
 */
export declare class Suggestion extends /* #__PURE__ -- @preserve */ Suggestion_base {
    /**
     * Suggestion ID.
     */
    readonly id: string;
