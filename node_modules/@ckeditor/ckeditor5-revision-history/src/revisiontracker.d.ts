...
import type { Revision, RevisionData } from './revision.js';
/**
 ...
 */
export declare class RevisionTracker extends Plugin {
    /**
     ...
     * @param version {@link module:engine/model/document~ModelDocument#version Document version} on which the revision is saved.
