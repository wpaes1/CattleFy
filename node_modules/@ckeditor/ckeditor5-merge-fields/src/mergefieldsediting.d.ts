 ...
 */
export declare class MergeFieldsEditing extends Plugin {
    /**
     ...
     */
    isMergeField(element: ModelElement): boolean;
    /**
     ...
     */
    getMergeFieldType(idOrElement: string | ModelElement): MergeFieldType | null;
    /**
