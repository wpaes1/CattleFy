...
export interface MergeFieldsConfig {
     ...
     */
    definitions?: Array<MergeFieldsGroupDefinition | MergeFieldDefinition>;
    /**
     ...
     * @default []
     */
    dataSets?: Array<MergeFieldsDataSetDefinition>;
    /**
     ...
     * {@link ~MergeFieldsDataSetDefinition#values data set values} and {@link ~MergeFieldDefinition#defaultValue default values} as
     * HTML strings and render them as HTML.
     *
...
export type MergeFieldsGroupDefinition = {
    /**
     * The unique identifier of the group.
     *
     * If {@link ~MergeFieldsGroupDefinition#groupLabel} is not specified, the ID will be used as a label in the UI.
     */
    groupId: string;
    /**
...
export type MergeFieldsDataSetDefinition = {
    /**
