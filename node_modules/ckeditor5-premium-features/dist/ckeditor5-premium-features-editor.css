...
.ck.ck-ai-review-mode .ck-ai-review-mode__check-list > .ck-ai-review-mode__check-list-item.ck-ai-review-mode__check-list-item_rendered{
				...
				transition:box-shadow 0.3s ease-in-out, opacity 0.1s calc(0.05s * var(--ck-ai-review-check-list-item-index)), visibility 0.1s calc(0.05s * var(--ck-ai-review-check-list-item-index));
			}
