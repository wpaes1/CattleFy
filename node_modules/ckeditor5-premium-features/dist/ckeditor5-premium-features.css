...
/*
		 * Footnotes use an ordered list to represent footnote definitions.
		 * The problem is that if we insert a list inside a footnote definition, the numbering of the
		 * nested list should have the decimal style instead of the lower-latin style. It's lower-latin
		 * because we place an ordered list inside another ordered list. It does not affect unordered lists.
		 */
...
.ck.ck-revision-history-sidebar__header {
	/* 
		...
		See https://github.com/ckeditor/ckeditor5-commercial/issues/6929.
	*/
	--header-height: max(
