...
export const templateCredentialsSchema = z
    ...
    name: z
        ...
        .min(4)
        .regex(/^[a-zA-Z-]+$/)
        .describe('Name of the Template Credentials. Must be longer than 3 characters, can only contain dashes and latin letters.'),
    type: z
        .enum([
        'azure',
        'backblaze',
...
`),
    ...
    .strict();
//# sourceMappingURL=templateCredential.js.map