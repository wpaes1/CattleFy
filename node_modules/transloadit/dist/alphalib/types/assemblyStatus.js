...
const assemblyStatusMetaSchema = z
    ...
    recognized_text: z
        ...
        .optional(),
    descriptions: z
        .array(z.union([z.string(), z.object({ name: z.string(), confidence: z.number() }).passthrough()]))
        .optional(),
 ...
 */
export function hasError(assembly, particularErrorCode) {
    const errorExists = Boolean(assembly) && assembly != null && typeof assembly === 'object' && 'error' in assembly;
    if (particularErrorCode) {
        return errorExists && assembly.error === particularErrorCode;
    }
    return errorExists;
}
export function hasSpecificError(assembly, errorType) {
    if (!assembly)
        return false;
 ...
 */
export function hasOk(assembly, particularOkCode) {
    const okExists = Boolean(assembly) && assembly != null && typeof assembly === 'object' && 'ok' in assembly;
    if (particularOkCode) {
 ...
 */
export function getError(assembly) {
 ...
 */
export function getOk(assembly) {
...
export function hasOkPartial(assembly) {
    return (Boolean(assembly) &&
        assembly != null &&
        typeof assembly === 'object' &&
        'ok' in assembly &&
...
//# sourceMappingURL=assemblyStatus.js.map