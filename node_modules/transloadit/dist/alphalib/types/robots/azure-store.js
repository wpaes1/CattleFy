import { z } from 'zod';
import { azureBase, interpolateRobot, robotBase, robotUse } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotAzureStoreInstructionsWithHiddenFieldsSchema = robotAzureStoreInstructionsSchema.extend({
    result: z
        .union([z.literal('debug'), robotAzureStoreInstructionsSchema.shape.result])
        .optional(),
});
export const interpolatableRobotAzureStoreInstructionsSchema = interpolateRobot(robotAzureStoreInstructionsSchema);
