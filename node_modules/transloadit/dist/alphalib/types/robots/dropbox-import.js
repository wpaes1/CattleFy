import { z } from 'zod';
import { dropboxBase, interpolateRobot, path, robotBase, robotImport, } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotDropboxImportInstructionsWithHiddenFieldsSchema = robotDropboxImportInstructionsSchema.extend({
    result: z
...
export const interpolatableRobotDropboxImportInstructionsSchema = interpolateRobot(robotDropboxImportInstructionsSchema);
export const interpolatableRobotDropboxImportInstructionsWithHiddenFieldsSchema = interpolateRobot(robotDropboxImportInstructionsWithHiddenFieldsSchema);
//# sourceMappingURL=dropbox-import.js.map