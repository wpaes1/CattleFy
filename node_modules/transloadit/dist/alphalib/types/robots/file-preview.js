import { z } from 'zod';
import { color_with_alpha, complexHeightSchema, complexWidthSchema, interpolateRobot, optimize_priority, resize_strategy, robotBase, robotUse, } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotFilePreviewInstructionsWithHiddenFieldsSchema = robotFilePreviewInstructionsSchema.extend({
    result: z
...
export const interpolatableRobotFilePreviewInstructionsWithHiddenFieldsSchema = interpolateRobot(robotFilePreviewInstructionsWithHiddenFieldsSchema);
