import { z } from 'zod';
import { ftpBase, interpolateRobot, robotBase, robotUse } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotFtpStoreInstructionsWithHiddenFieldsSchema = robotFtpStoreInstructionsSchema.extend({
...
export const interpolatableRobotFtpStoreInstructionsSchema = interpolateRobot(robotFtpStoreInstructionsSchema);
export const interpolatableRobotFtpStoreInstructionsWithHiddenFieldsSchema = interpolateRobot(robotFtpStoreInstructionsWithHiddenFieldsSchema);
//# sourceMappingURL=ftp-store.js.map