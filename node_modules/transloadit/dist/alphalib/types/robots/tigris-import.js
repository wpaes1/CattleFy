import { z } from 'zod';
import { files_per_page, interpolateRobot, page_number, path, recursive, return_file_stubs, robotBase, robotImport, tigrisBase, } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotTigrisImportInstructionsWithHiddenFieldsSchema = robotTigrisImportInstructionsSchema.extend({
    result: z
...
//# sourceMappingURL=tigris-import.js.map