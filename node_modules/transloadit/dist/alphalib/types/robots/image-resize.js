import { z } from 'zod';
import { color_without_alpha_with_named, colorspaceSchema, complexHeightSchema, complexWidthSchema, imageQualitySchema, interpolateRobot, percentageSchema, positionSchema, robotBase, robotImagemagick, robotUse, unsafeCoordinatesSchema, } from "./_instructions-primitives.js";
export const meta = {
...
In this example, the background color is determined by the [Assembly Variable](https://transloadit.com/docs/topics/assembly-instructions/#assembly-variables) \`\${file.meta.average_color}\`. If you set \`zoom\` to \`false\` (default is \`true\`), smaller images will be centered horizontally and vertically, and have the background padding all around them.`),
        z
            .literal('stretch')
            .describe('Ignores aspect ratio, resizing the image to the exact width and height specified. This may result in a stretched or distorted image.'),
    ])
        .default('fit')
        .describe(`
...
`),
    ...
    .strict();
export const robotImageResizeInstructionsWithHiddenFieldsSchema = robotImageResizeInstructionsSchema.extend({
    result: z
...
export const interpolatableRobotImageResizeInstructionsSchema = interpolateRobot(robotImageResizeInstructionsSchema);
