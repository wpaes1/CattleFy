...
`),
    ...
    .strict();
export const robotFileVirusscanInstructionsWithHiddenFieldsSchema = robotFileVirusscanInstructionsSchema.extend({
    result: z
...
export const interpolatableRobotFileVirusscanInstructionsSchema = interpolateRobot(robotFileVirusscanInstructionsSchema);
export const interpolatableRobotFileVirusscanInstructionsWithHiddenFieldsSchema = interpolateRobot(robotFileVirusscanInstructionsWithHiddenFieldsSchema);
//# sourceMappingURL=file-virusscan.js.map