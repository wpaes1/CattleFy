import { z } from 'zod';
import { interpolateRobot, return_file_stubs, robotBase, robotImport, } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotHttpImportInstructionsWithHiddenFieldsSchema = robotHttpImportInstructionsSchema.extend({
...
export const interpolatableRobotHttpImportInstructionsSchema = interpolateRobot(robotHttpImportInstructionsSchema);
export const interpolatableRobotHttpImportInstructionsWithHiddenFieldsSchema = interpolateRobot(robotHttpImportInstructionsWithHiddenFieldsSchema);
//# sourceMappingURL=http-import.js.map