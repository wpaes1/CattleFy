import { z } from 'zod';
import { interpolateRobot, robotBase, robotImport, sftpBase } from "./_instructions-primitives.js";
export const meta = {
...
`),
    ...
    .strict();
export const robotSftpImportInstructionsWithHiddenFieldsSchema = robotSftpImportInstructionsSchema.extend({
    result: z
...
export const interpolatableRobotSftpImportInstructionsWithHiddenFieldsSchema = interpolateRobot(robotSftpImportInstructionsWithHiddenFieldsSchema);
//# sourceMappingURL=sftp-import.js.map