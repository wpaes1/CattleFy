import { z } from 'zod';
import { interpolateRobot, robotBase, robotUse, sftpBase } from "./_instructions-primitives.js";
export const meta = {
...
This optional parameter controls how an uploaded file's permission bits are set. You can use any string format that the \`chmod\` command would accept, such as \`"755"\`. If you don't specify this option, the file's permission bits aren't changed at all, meaning it's up to your server's configuration (e.g. umask).
    ...
    .strict();
export const robotSftpStoreInstructionsWithHiddenFieldsSchema = robotSftpStoreInstructionsSchema.extend({
...
export const interpolatableRobotSftpStoreInstructionsSchema = interpolateRobot(robotSftpStoreInstructionsSchema);
export const interpolatableRobotSftpStoreInstructionsWithHiddenFieldsSchema = interpolateRobot(robotSftpStoreInstructionsWithHiddenFieldsSchema);
//# sourceMappingURL=sftp-store.js.map