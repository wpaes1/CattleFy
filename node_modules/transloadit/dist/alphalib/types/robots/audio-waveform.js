import { z } from 'zod';
import { color_with_alpha, interpolateRobot, robotBase, robotFFmpeg, robotUse, } from "./_instructions-primitives.js";
export const meta = {
...
export const interpolatableRobotAudioWaveformInstructionsSchema = interpolateRobot(robotAudioWaveformInstructionsSchema);
export const interpolatableRobotAudioWaveformInstructionsWithHiddenFieldsSchema = interpolateRobot(robotAudioWaveformInstructionsWithHiddenFieldsSchema);
