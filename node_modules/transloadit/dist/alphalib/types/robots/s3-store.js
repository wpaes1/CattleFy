import { z } from 'zod';
import { interpolateRobot, robotBase, robotUse, s3Base } from "./_instructions-primitives.js";
export const meta = {
...
export const interpolatableRobotS3StoreInstructionsSchema = interpolateRobot(robotS3StoreInstructionsSchema);
export const interpolatableRobotS3StoreInstructionsWithHiddenFieldsSchema = interpolateRobot(robotS3StoreInstructionsWithHiddenFieldsSchema);
