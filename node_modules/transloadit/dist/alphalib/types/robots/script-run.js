...
`),
    ...
    .strict();
export const robotScriptRunInstructionsWithHiddenFieldsSchema = robotScriptRunInstructionsSchema.extend({
...
export const interpolatableRobotScriptRunInstructionsSchema = interpolateRobot(robotScriptRunInstructionsSchema);
export const interpolatableRobotScriptRunInstructionsWithHiddenFieldsSchema = interpolateRobot(robotScriptRunInstructionsWithHiddenFieldsSchema);
