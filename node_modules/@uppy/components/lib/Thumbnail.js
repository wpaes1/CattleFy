...
export default function Thumbnail(props) {
  var _props$file$type, _props$file$type2;
  const width = props.width || '100%';
  const height = props.height || '100%';
  const fileTypeGeneral = ((_props$file$type = props.file.type) == null ? void 0 : _props$file$type.split('/')[0]) || '';
  const fileTypeSpecific = ((_props$file$type2 = props.file.type) == null ? void 0 : _props$file$type2.split('/')[1]) || '';
  const isImage = props.file.type.startsWith('image/');
  const isArchive = fileTypeGeneral === 'application' && ['zip', 'x-7z-compressed', 'x-zip-compressed', 'x-rar-compressed', 'x-tar', 'x-gzip', 'x-apple-diskimage'].includes(fileTypeSpecific);
  ...
  return h("div", {
    ...
    src: objectUrl,
    alt: props.file.name
  }) : null, !showThumbnail ? h("div", {
    className: "uppy:flex uppy:flex-col uppy:items-center uppy:justify-center uppy:w-full uppy:h-full"
  }, h("div", {
    className: "uppy:flex-1 uppy:flex uppy:items-center uppy:justify-center uppy:w-full"
  }, !props.file.type ? h("svg", {
    "aria-hidden": "true",
  ...
  }))) : null, fileTypeGeneral === 'text' ? h("svg", {
    "aria-hidden": "true",
    className: "uppy:w-3/4 uppy:h-3/4",
    viewBox: "0 0 25 25"
  }, h("path", {
    ...
    fill: "#5A5E69",
    "fill-rule": "nonzero"
  })) : null, fileTypeGeneral === 'image' && !showThumbnail ? h("svg", {
    "aria-hidden": "true",
    className: "uppy:w-3/4 uppy:h-3/4",
    viewBox: "0 0 25 25"
  }, h("g", {
    ...
    cy: "9.5",
    r: "1.5"
  }))) : null, fileTypeGeneral === 'audio' ? h("svg", {
    "aria-hidden": "true",
    className: "uppy:w-3/4 uppy:h-3/4",
    viewBox: "0 0 25 25"
  }, h("path", {
    ...
    fill: "#049BCF",
    "fill-rule": "nonzero"
  })) : null, fileTypeGeneral === 'video' ? h("svg", {
    "aria-hidden": "true",
    className: "uppy:w-3/4 uppy:h-3/4",
    viewBox: "0 0 25 25"
  }, h("path", {
    ...
    fill: "#00C469",
    "fill-rule": "nonzero"
  })) : null, props.file.type && !fileTypeGeneral && !isPDF && !isArchive ? h("svg", {
    "aria-hidden": "true",
    className: "uppy:w-3/4 uppy:h-3/4",
    viewBox: "0 0 25 25"
  }, h("g", {
