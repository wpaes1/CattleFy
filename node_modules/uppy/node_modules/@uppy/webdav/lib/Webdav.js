...
const AuthForm = ({ i18n, onAuth, }) => {
    const [webdavUrl, setWebdavUrl] = useState('');
    const onSubmit = useCallback(() => {
        onAuth({ webdavUrl: webdavUrl.trim() });
    }, [onAuth, webdavUrl]);
    return (_jsx(SearchInput, { searchString: webdavUrl, setSearchString: setWebdavUrl, submitSearchString: onSubmit, inputLabel: i18n('pluginWebdavInputLabel'), buttonLabel: i18n('authenticate'), wrapperClassName: "uppy-SearchProvider", inputClassName: "uppy-c-textInput uppy-SearchProvider-input", showButton: true, buttonCSSClassName: "uppy-SearchProvider-searchButton" }));
};
